...
pub fn installDependencies(
    ...
    try setupEnvironment(allocator, env_config, env_name, base_dir, deps_slice, force_deps, force_rebuild, modules_verified, use_default_python, dev_mode, cache_mode);
}
